...
ActivitiesRoutes.delete('/eliminar/:idActividades',verificar, eliminarActividades)
ActivitiesRoutes.put('/actualizar/:id_actividades',verificar,validar_actividad, actualizarActividades)
