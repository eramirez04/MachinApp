...
export const middlewareUsuario = [
    ...
    check('apellidos', 'Campo apellidos es requirido').not().isEmpty().isLength({ max: 100, min: 2 }),
...
export const middelwareActualizarContra = [
    check('numero_identificacion', 'Campo requirido').not().isEmpty().isLength({ max: 15, min: 5 }),
]