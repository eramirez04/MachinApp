export const CardDataStats = ({ title, total, children }) => {
  return (
    <div className="rounded-lg border border-green-400 bg-green-50 p-2 shadow-lg hover:shadow-xl hover:bg-green-100">
      <div className="flex h-10 cursor-pointer w-10 items-center justify-center rounded-full bg-green-500 dark:bg-green-700 transition-all duration-300 hover:bg-green-600 dark:hover:bg-green-800">
        {children}
      </div>
