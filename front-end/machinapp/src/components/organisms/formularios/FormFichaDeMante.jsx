...
export const FormFichaDeMantenimiento = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-4xl mx-auto p-4">
      ...
      <CardStyle titleCard="Tipo de operación">
        <SelectComponent
          register={register}
          name="maintenanceType"
          options={[
            { valor: 'preventive', text: 'Preventivo' },
            { valor: 'corrective', text: 'Correctivo' }
          ]}
      ...
      <CardStyle titleCard="Trabajo solicitado">
        <Textarea
          register={register}
          name="description"
      ...
      <CardStyle titleCard="Repuestos utilizados y costos">
        <div className="grid grid-cols-3 gap-4">
          <InputforForm register={register} errors={errors} name="partDescription" tipo="text" placeholder="Descripción" />
          <InputforForm register={register} errors={errors} name="partName" tipo="text" placeholder="Nombre repuesto" />
          <InputforForm register={register} errors={errors} name="partCost" tipo="number" placeholder="Costo" />
        </div>
      </CardStyle>
